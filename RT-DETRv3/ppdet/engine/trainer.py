...
class Trainer(object):
    ...
    def _eval_with_loader(self, loader):
        ...
        metrics = copy.deepcopy(self._metrics.copy())
        self._reset_metrics()
        ...
        metrics = [metric.get_results() for metric in metrics]
        for x in metrics:
            x.update({
                'Sum Eval': total_update_eval_time,
                'Avg Eval': total_update_eval_time/5000,
                'Infer time': total_forward_time,
                'Avg Infer': total_forward_time/5000,
            })
        return metrics
    ...
    def evaluate(self):
        ...
        with paddle.no_grad():
            metrics = self._eval_with_loader(self.loader)
        return metrics
